...
import { Navbar, Nav } from 'react-bootstrap'; //, NavDropdown, FormControl, Dropdown
      ...
      <Navbar id="navBar" bg={background} variant={variant} expand="md" fixed="top" style={{padding: 1}}>
        ...
        <Navbar.Collapse id="navCollapse" className="py-0">
          <Nav id="navLinks" className="mr-auto" variant="pills" activeKey="none">
            ...
            {/*<Link to={AppPaths.Pages.Donations.Index} className="nav-link px-2">Donations</Link>*/}
            {/*<Link to={AppPaths.Pages.Veterans.Index} className="nav-link px-2">Veterans</Link>*/}
          ...
          <span id="navTools" className="mb-1 px-2 my-md-0 px-md-0 d-flex">
            ...
            <LoginMenu className={`btn btn-${background}`}/>
          </span>
          */}
        </Navbar.Collapse>
      </Navbar>
